 ...
 */
public class CrossCorrelationTranspose3DKernel extends Kernel {

	public void execute(Tensor input, Tensor weight, IntTuple3 stride, IntTuple3 padding, int groups,
			IntTuple3 dilation, Tensor result) {
