 ...
 */
public class LogarithmKernel extends Kernel {

	public void execute(FloatArray base, FloatArray antilogarithm, FloatArray result) {
		Calling c = call();
		c.in(base).in(antilogarithm).out(result);
